...
#ifndef LISTAHET_LISTAHET_H
#define LISTAHET_LISTAHET_H
...
/*Tipo que define a lista heterogenea(tipo opaco)
  ...
  Use o ponteiro gen�rico para implementar a lista (void*)
...
/*Imprime os elementos da lista. Para cada elemento da lista, deve-se imprimir os dados do Cliente,
 *seguido dos dados do im�vel (caso o item seja um im�vel) ou dos dados do autom�vel
 * (caso o item seja um movel)
* inputs: a lista
* output: nao tem
